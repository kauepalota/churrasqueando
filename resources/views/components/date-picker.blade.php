                ...
                <div
                    ...
                    <div class="grid grid-cols-7">
                        ...
                        <template x-for="(date, dateIndex) in datePickerDaysInMonth" :key="dateIndex">
                            <div @click="datePickerDayClicked(date)" x-text="date" class="p-1 text-sm leading-none text-center transition duration-100 ease-in-out border border-transparent rounded-full cursor-pointer select-none h-7 w-7 focus:outline-none focus:shadow-outline hover:bg-red-300" :class="{'bg-neutral-200/70 text-gray-700 font-medium' : datePickerIsToday(date) , 'bg-red-500 text-white font-semibold' : datePickerIsSelectedDate(date) }"></div>
                        </template>
                    </div>
                    <div class="grid grid-cols-2 mt-4 gap-x-2">
                        ...
                        <input type="number" x-model="datePickerHours" min="0" max="23" class="w-full px-3 py-2 text-sm bg-white border rounded-md text-neutral-600 border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400" />
                        <input type="number" x-model="datePickerMinutes" min="0" max="59" class="w-full px-3 py-2 text-sm bg-white border rounded-md text-neutral-600 border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400" />
                    </div>
                </div>
            </div>
        </div>
